...
def main(args):
    ...
    try:
        tespeed = TeSpeed(server=args.listservers and 'list-servers' or args.server, num_servers=args.servercount,
                          num_top=args.listservers, unit=args.unit, chunk_size=args.chunksize, log=log)
        tespeed.run_tests()
